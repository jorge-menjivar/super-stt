...
|---------------------------------------------------------------------------------------|-------------------|-----------------------------------------------------------------------|
| [`/backends/{backend_id}/secrets`](../endpoints/v1/backends/secrets.md#get-backendsbackend_idsecrets) | GET | List declared secrets and whether each is configured — no values. |
