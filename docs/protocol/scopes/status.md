...
[`GET /pipeline/1`](../endpoints/v1/pipeline/stage.md) and
[`GET /pipeline/{stage}/model/{model}/device`](../endpoints/v1/pipeline/device.md#get-pipelinestagemodelmodeldevice).
