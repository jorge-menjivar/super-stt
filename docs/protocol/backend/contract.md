...
[`/pipeline/1/model`](../endpoints/v1/pipeline/model.md):
...
> [pipeline/model-list.md](../endpoints/v1/pipeline/model-list.md) are reconciled with this definition.
