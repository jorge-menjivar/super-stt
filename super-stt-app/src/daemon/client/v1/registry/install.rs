...
pub async fn install_by_source(source: &str) -> Result<InstallAccepted, String> {
...
pub async fn install_by_repo_url(repo_url: &str) -> Result<InstallAccepted, String> {
...
pub async fn install_by_local_path(local_path: &str) -> Result<InstallAccepted, String> {
