...
//! End-to-end harness for the OpenAI WASM backend: loads the component,
...
/// Happy path: the component shapes the OpenAI request (bearer auth +
...
async fn transcribe_round_trip() {
    ...
    Mock::given(method("POST"))
        ...
        // Proves the component forwarded the injected x-stt-secret-OPENAI_API_KEY
