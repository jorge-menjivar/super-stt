...
use super::super::wire::{WriteMethodState, WriteMethodTest};
...
`POST /settings/write_method/test` before committing a user to it.",
...
session can differ \u{2014} `POST /settings/write_method/test` reports both."
);
settings_dispatch!(
    test_write_method,
    "test_write_method",
    post "/settings/write_method/test",
    WriteMethodTest,
