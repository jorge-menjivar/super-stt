...
accelerators and this Super STT's version, so the list reflects what is installable here \
...
the right GPU will never run it, but a Super STT one version behind is something the user \
